...
<div class="signup__container">
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      ...
      <h2 class="heading--secondary">voulez-vous vous connecter?</h2>
    </div>
    ...
    <form action="login" method="Get">
      ...
      <div class="m-t-lg">
        <ul class="list-inline">
          <li>
            <input class="btn btn--form" type="submit" value="connecter" />
          </li>
          <li>
            <a class="signup__link" href="register.jsp">inscrivez vous</a>
          </li>
        </ul>
      </div>
    </form>  
