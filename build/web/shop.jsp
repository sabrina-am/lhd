<%-- 
    Document   : shop
    Created on : 7 déc. 2019, 16:00:01
...
<html lang="en">
  ...
  <body class="goto-here">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta cta-colored">
                       <a href="cart.html" class="nav-link"><span class="icon-shopping_cart"></span>[0]
                       </a>
                  </li>
                  <li class="nav-item dropdown">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/product-10.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Acceuil</a></span> <span>Produits</span></p>
 ...
 <%
            ...
            ResultSet r;
            if(id.isEmpty()==true){
                r =f.executeQuery("select DISTINCT image_pr,nom_pr,prix_pr,id_produit,rating FROM produit");
            }
            else{  
               r =f.executeQuery("select  DISTINCT image_pr,nom_pr,prix_pr,id_produit from produit where type_vtm = "+id);
            }                       
   %>
    <section class="ftco-section">
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-11 mb-5 text-center">
    				<ul class="product-category">
                                    <li><a href="shop.jsp?&categorie" <% if(id.isEmpty()==true) {%>class="active"<%}%>>All</a></li>
                                    <li><a href="shop.jsp?&categorie='tapis'" <% if(id.equalsIgnoreCase("'tapis'")==true) {%>class="active"<%}%>>Tapis</a></li>
                                    <li><a href="shop.jsp?&categorie='vetement'" <% if(id.equalsIgnoreCase("'vetement'")==true) {%>class="active"<%}%>>Vetements</a></li>
                                    <li><a href="shop.jsp?&categorie='gateau'" <% if(id.equalsIgnoreCase("'gateau'")==true) {%>class="active"<%}%>>Gateaux</a></li>
                                    <li><a href="shop.jsp?&categorie='bijou'" <% if(id.equalsIgnoreCase("'bijou'")==true) {%>class="active"<%}%>>Bijoux</a></li>
                                    <li><a href="shop.jsp?&categorie='poterie'" <% if(id.equalsIgnoreCase("'poterie'")==true) {%>class="active"<%}%>>Poteries</a></li>
                                    <li><a href="shop.jsp?&categorie='vannerie'" <% if(id.equalsIgnoreCase("'vannerie'")==true) {%>class="active"<%}%>>Vanneries</a></li>
                                    <li><a href="shop.jsp?&categorie='broderie'" <% if(id.equalsIgnoreCase("'broderie'")==true) {%>class="active"<%}%>>Broderies</a></li>
                                    <li><a href="shop.jsp?&categorie='dinanderie'" <% if(id.equalsIgnoreCase("'dinanderie'")==true) {%>class="active"<%}%>>Dinanderies</a></li>
    		...
    		<div class="row">
                    <% 
                         while (r.next()){
                         byte[] imgData = r.getBytes("image_pr"); // blob field 
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#"><%=r.getString("nom_pr") %></a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc"><%=r.getString("prix_pr") %> Da</span><span class="price-sale">650.00 Da</span></p>
		    					</div>
	    					</div>
